...
simulator_state_t* sim_init(size_t pool_0_size, size_t pool_1_size, size_t pool_2_size, size_t pool_3_size, policy_t policy, unsigned alignement, size_t free_header_size, size_t alloc_header_size);
